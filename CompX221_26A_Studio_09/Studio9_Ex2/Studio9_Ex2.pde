...
void setup()
{
  ...
  selectedDataSet = null;
    ...
    b1 = new Button
    (300, 550, #77F5F4, 100, 50, "Data Set 1");
  
    b2 = new Button
    (500, 550, #77F5F4, 100, 50, "Data Set 2");
...
void draw()
{
  ...
  {
    selectedDataSet.plotDataSet(BOTTOM); 
  }
...
void mousePressed()
{
 if(b1.isClicked(mouseX, mouseY) == true)
 {
   selectedDataSet = d1; 
 }
  else if (b2.isClicked(mouseX, mouseY) == true)
  {
   selectedDataSet = d2; 
  }
